...
export function StyledH1({ text, style = {}, weight = "regular", numberOfLines = 0, ellipsizeMode = "tail" }: Props) {
  ...
  return (
    <Text style={[fontStyles.styledH1, style]} numberOfLines={numberOfLines} ellipsizeMode={ellipsizeMode}>
      {text}
    </Text>
  );
}
...
export function StyledH2({ text, style = {}, weight = "medium", numberOfLines = 0, ellipsizeMode = "tail" }: Props) {
  ...
  return (
    <Text
      style={[fontStyles.styledH2, { fontFamily: fontFamily }, style]}
...
export function StyledH3({ text, style = {}, weight = "regular", numberOfLines = 0, ellipsizeMode = "tail" }: Props) {
  ...
  return (
    <Text style={[fontStyles.styledH3, style]} numberOfLines={numberOfLines} ellipsizeMode={ellipsizeMode}>
      {text}
    </Text>
  );
}
...
export function StyledH4({ text, style = {}, weight = "regular", numberOfLines = 0, ellipsizeMode = "tail" }: Props) {
  ...
  return (
    <Text style={[fontStyles.styledH4, style]} numberOfLines={numberOfLines} ellipsizeMode={ellipsizeMode}>
      {text}
    </Text>
  );
}
